        ...
        <div className="flex min-h-screen items-center justify-center md:justify-end px-4 sm:px-6 py-20 md:py-20">
          <div className="max-w-4xl w-full text-center md:text-right md:pr-12 lg:pr-20 xl:pr-32">
            ...
            <p className="mb-8 sm:mb-10 text-base sm:text-lg md:text-xl leading-relaxed text-white/90 drop-shadow-md max-w-2xl mx-auto md:ml-auto">
              The most secure and reliable platform designed specifically for legal professionals. 
              Streamline your practice, manage cases efficiently, and keep your data protected 
              with our intuitive legal management system.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center md:justify-end gap-3 sm:gap-4">
              ...
              <div className="relative w-full sm:w-auto" ref={dropdownRef}>
                <button
                  onClick={() => setIsTryDropdownOpen(!isTryDropdownOpen)}
                ...
                <div
                  className={`absolute top-full left-0 right-0 sm:left-0 sm:right-auto mt-2 w-full sm:w-64 bg-white rounded-xl shadow-2xl border border-neutral-200 overflow-hidden transition-all duration-200 origin-top z-50 ${
                    isTryDropdownOpen ? 'opacity-100 scale-100 visible' : 'opacity-0 scale-95 invisible'
                  }`}
                >
                  <div className="py-2">
                    <Link
                      ...
                      onClick={() => setIsTryDropdownOpen(false)}
                    >
                      <div className="font-semibold text-neutral-900">Try as Lawyer</div>
                    ...
                    <Link
                      ...
                      onClick={() => setIsTryDropdownOpen(false)}
                    >
                      <div className="font-semibold text-neutral-900">Try as Law Firm</div>
                      <div className="text-sm text-neutral-500 mt-1">
            ...
            <div className="mt-12 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white rounded-xl p-5 sm:p-6 shadow-xl">
                ...
                <h3 className="font-semibold text-lg mb-2 text-black">Bank-Level Security</h3>
              ...
              <div className="bg-white rounded-xl p-5 sm:p-6 shadow-xl">
                ...
                <h3 className="font-semibold text-lg mb-2 text-black">Easy to Use</h3>
                <p className="text-sm text-neutral-600">
              ...
              <div className="bg-white rounded-xl p-5 sm:p-6 shadow-xl sm:col-span-2 md:col-span-1">
                ...
                <h3 className="font-semibold text-lg mb-2 text-black">Complete Solution</h3>
                <p className="text-sm text-neutral-600">
                  Manage cases, documents, and clients in one place
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-12 md:mb-16">
              ...
              <p className="text-base sm:text-lg text-neutral-600 max-w-3xl mx-auto px-4">
                Built specifically for the legal industry with features that matter most to attorneys and law firms
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg sm:text-xl mb-2 text-black">Compliance Ready</h3>
                <p className="text-sm sm:text-base text-neutral-600 px-2">
                  Meet all legal industry compliance requirements including attorney-client privilege protection
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg sm:text-xl mb-2 text-black">Document Security</h3>
                <p className="text-sm sm:text-base text-neutral-600 px-2">
                  End-to-end encryption ensures sensitive legal documents remain confidential
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg sm:text-xl mb-2 text-black">Time Tracking</h3>
                <p className="text-sm sm:text-base text-neutral-600 px-2">
                  Accurate billable hours tracking with automated time entries and reporting
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-bold text-lg sm:text-xl mb-2 text-black">Client Portal</h3>
                <p className="text-sm sm:text-base text-neutral-600 px-2">
                  Secure client communication and document sharing through dedicated portals
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-center">
              <div>
                ...
                <div className="text-sm sm:text-base text-neutral-400">Legal Professionals</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">500+</div>
                <div className="text-sm sm:text-base text-neutral-400">Law Firms</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">99.9%</div>
                <div className="text-sm sm:text-base text-neutral-400">Uptime SLA</div>
              </div>
              <div>
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2">24/7</div>
                <div className="text-sm sm:text-base text-neutral-400">Support Available</div>
              </div>
            </div>
          </div>
        </section>
